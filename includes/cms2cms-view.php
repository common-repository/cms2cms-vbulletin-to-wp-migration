<?php
if (!defined('CMS2CMS_VBULL_VERSION')) {
    die();
}
...
$key              = get_option('cms2cms-vBulletin-key');
$activated        = $dataProvider->isActivated();
$targetUrl        = get_site_url();
$authentication   = $dataProvider->getAuthData();
$ajaxNonce        = $dataProvider->getFormTempKey('cms2cms-vBulletin-ajax-security-check');
$currentPluginUrl = plugin_dir_url(__FILE__);
$jsConfig         = $dataProvider->getConfig(true);
$config           = $dataProvider->getConfig();
$loader           = new CmsBridgevBulletinLoader();

$styles = array($dataProvider->getFrontUrl() . 'css/cms2cms.css?v=' . CMS2CMS_VBULL_VERSION);
foreach ($styles as $style) {
    printf('<link rel="stylesheet" href="%s" type="text/css" media="all">', $style);
}

$scripts = array(
    $dataProvider->getFrontUrl() . 'js/jsonp.js?v=' . CMS2CMS_VBULL_VERSION,
    $dataProvider->getFrontUrl() . 'js/cms2cms.js?v=' . CMS2CMS_VBULL_VERSION
);
...
?>
<div class="wrap cms2cms-vBulletin-wrapper">
    <div class="cms2cms-vBulletin-container">
        <div class="cms2cms-vBulletin-header">
        ...
        <?php if ($activated) { ?>
            <script language="JavaScript">
                jQuery('.cms2cms-vBulletin-container').addClass('cms2cms_vBulletin_is_activated');
            </script>
            <div class="cms2cms-vBulletin-message">
                <span>
                    <?php echo sprintf(
                        $dataProvider->__('You are logged in CMS2CMS as %s', $fileStart),
                        get_option('cms2cms-vBulletin-login')
                    ); ?>
                </span>
                <div class="cms2cms-vBulletin-logout">
                    <form action="" method="post" id="logout" data-logout="<?php echo $dataProvider->getLogOutUrl() ?>">
                        <input type="hidden" name="cms2cms_vBulletin_logout" value="1"/>
                        <input type="hidden" name="_wpnonce"
                               value="<?php echo $dataProvider->getFormTempKey('cms2cms_vBulletin_logout') ?>"/>
                        <button class="button-grey cms2cms-vBulletin-button" data-log-this="Logout" type="button">
        ...
        <?php } ?>
        <div class="cms2cms-vBulletin-plugin">
            <div id="cms2cms_vBulletin_accordeon">
                ...
                <?php
                $cms2cms_vBulletin_step_counter = 1;
                if (!$activated) { ?>
                    <div id="cms2cms_vBulletin_accordeon_item_id_<?php echo $cms2cms_vBulletin_step_counter++; ?>"
                         class="step-body cms2cms_vBulletin_accordeon_item cms2cms_vBulletin_accordeon_item_register">
                        ...
                        <form action="<?php echo $dataProvider->getLoginUrl() ?>"
                              ...
                              class="step_form"
                              id="cms2cms_vBulletin_form_register">
                            <div class="center-content">
                                <div class="error_message"></div>
                                <div class="user-name-block" style="display: none">
                                    <label
                                            for="cms2cms-vBulletin-user-name"><?php $dataProvider->_e('Full Name', $fileStart); ?></label>
                                    <input type="text" maxlength="50" id="cms2cms-vBulletin-user-name" name="name"
                                           value="" placeholder="Your name" class="regular-text"/>
                                    <div class="cms2cms-vBulletin-error name">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>
                                <div>
                                    <label
                                            for="cms2cms-vBulletin-user-email"><?php $dataProvider->_e('Email', $fileStart); ?></label>
                                    <input type="text" id="cms2cms-vBulletin-user-email" name="email"
                                           value="" placeholder="Your email" class="regular-text"/>
                                    <div class="cms2cms-vBulletin-error email">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>
                                <div>
                                    <label
                                            for="cms2cms-vBulletin-user-password"><?php $dataProvider->_e('Password', $fileStart); ?></label>
                                    <input type="password" id="cms2cms-vBulletin-user-password" name="password" value=""
                                           placeholder="Your password" class="regular-text"/>
                                    <div class="cms2cms-vBulletin-error password">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>

                                <input type="hidden" id="cms2cms-vBulletin-user-plugin" name="referrer"
                                       value="<?php echo $dataProvider->getPluginReferrerId(); ?>"
                                       class="regular-text"/>
                                <input type="hidden" id="cms2cms-vBulletin-site-url" name="siteUrl"
                                ...
                                <button
                                        ...
                                        type="button" id="auth_submit" class="cms2cms-vBulletin-button button-green">
                                ...
                                <a data-log-this="Forgot Password Link clicked"
                                   ...
                                   class="cms2cms-vBulletin-real-link" >
                ...
                <?php } /* cms2cms_vBulletin_is_activated */ ?>
                ...
                <div id="cms2cms_vBulletin_accordeon_item_id_<?php echo $cms2cms_vBulletin_step_counter++; ?>"
                     class="step-body cms2cms_vBulletin_accordeon_item">
                    <?php if (isset($message)) {?>
                        <div class="container-erorr-1">
                            <div class="block-erorr alert r-b-e">
                                <?php $dataProvider->_e(sprintf('%s Please contact our', $message), $fileStart); ?>
                    ...
                    <form action="<?php echo $dataProvider->getWizardUrl(); ?>"
                          method="post"
                          id="cms2cms_vBulletin_form_estimate">
                        <div class="center-content">
                            <div class="error_message"></div>
                            <div id='error'></div>
                            <p>
                                <a href="<?php echo $dataProvider->getBridgeUrl(); ?>"><?php $dataProvider->_e('Download Bridge', $fileStart); ?> </a> <?php $dataProvider->_e('and upload it to your vBulletin site root folder. For more information, please', $fileStart); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="sourceUrl" name="sourceUrl" value="" class="regular-text"
                                       ...
                                       ?>"/>
                                <div class="cms2cms-vBulletin-error">
                                    <div class="error-arrow"></div>
                                    <span></span></div>
                            </div>
                            ...
                            <input type="hidden" id="key" name="key"
                                   value="<?php echo $key; ?>"/>
                            <button id="verifySource_vBulletin"
                                    data-log-this="Verify Source Button pressed"
                                    type="button" name="verify-source" class="cms2cms-vBulletin-button button-green">
                                <?php $dataProvider->_e('Verify Connection', $fileStart); ?>
                            </button>
                        </div>
                    </form>
                    <div class="cms2cms-vBulletin-error"></div>
                </div>
            </div>
        </div> <!-- /plugin -->
