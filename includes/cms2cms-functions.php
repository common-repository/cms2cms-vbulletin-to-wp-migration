...
/**
 * Class CmsPluginFunctionsvBulletin
 */
class CmsPluginFunctionsvBulletin
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback"     : "//wordpress.org/support/plugin/cms2cms-vbulletin-to-wp-migration/reviews",
    ...
    {
        $cms2cms_vBulletin_access_login = get_option('cms2cms-vBulletin-login');
        $cms2cms_vBulletin_access_key   = get_option('cms2cms-vBulletin-key');

        return array(
            'email'     => $cms2cms_vBulletin_access_login,
            'accessKey' => $cms2cms_vBulletin_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_vBulletin_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-vBulletin-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-vBulletin-key', $key);

            delete_option('cms2cms-vBulletin-login');
            add_option('cms2cms-vBulletin-login', $login);

            delete_option('cms2cms-vBulletin-depth');
            add_option('cms2cms-vBulletin-depth', $bridge_depth);
    ...
    {
        return $this->__('vBulletin', 'cms2cms-vBulletin-migration');
    }
    ...
    {
        return $this->__('WordPress', 'cms2cms-vBulletin-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-vBulletin-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-vBulletin-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
    ...
    public function getExtensionUrl()
    {
        ...
        return $config['vBulletinExtension'];
    }
    ...
    public function logOut()
    {
        if (isset($_REQUEST['_wpnonce'])) {
            ...
            if ($this->verifyFormTempKey($nonce, 'cms2cms_vBulletin_logout')
                && $_POST['cms2cms_vBulletin_logout'] == 1
            ) {
                $this->clearOptions();
            }
        }
